 ...
 *  USA
 *
 *  $Id: s_serv.h 1119 2011-01-07 22:01:47Z michael $
 */
...
#define CAP_ENC_AES_128         0x00000200
#define CAP_ENC_AES_256         0x00000400
...
#define USE_CIPHER_AES128   1
#else
#define USE_CIPHER_AES128   0
#endif
/* AES256 */
#ifdef HAVE_EVP_AES_256_CFB
#define USE_CIPHER_AES256   1
#else
#define USE_CIPHER_AES256   0
#endif
...
#define CAP_ENC_MASK \
             (((USE_CIPHER_BF   * CAP_ENC_ALL) & CAP_ENC_BF_128)         | \
              ...
              ((USE_CIPHER_AES128 * CAP_ENC_ALL) & CAP_ENC_AES_128)        | \
              ((USE_CIPHER_AES256 * CAP_ENC_ALL) & CAP_ENC_AES_256)        | \
