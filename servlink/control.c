 ...
 *
 *   $Id: control.c 33 2005-10-02 20:50:00Z knight $
 */
...
cmd_set_crypt_in_cipher(struct ctrl_command *cmd)
{
  ...
  switch (cipher)
  {
    ...
    case CIPHER_AES_128:
      in_state.crypt_state.cipher = EVP_aes_128_cfb();
      break;
#endif
#ifdef HAVE_EVP_AES_256_CFB
    case CIPHER_AES_256:
      in_state.crypt_state.cipher = EVP_aes_256_cfb();
      break;
#endif
...
#ifdef HAVE_EVP_AES_128_CFB
    case CIPHER_AES_128:
      out_state.crypt_state.cipher = EVP_aes_128_cfb();
      break;
#endif
#ifdef HAVE_EVP_AES_256_CFB
    case CIPHER_AES_256:
      out_state.crypt_state.cipher = EVP_aes_256_cfb();
      break;
#endif
#ifdef HAVE_EVP_BF_CFB
    case CIPHER_BF:
