 ...
 *  USA
 *
 *  $Id: version.c 1135 2011-05-28 19:27:34Z michael $
 */
...
const char *infotext[] =
{
  ...
  "",
  "IRCASC ircd based on ircd-hybrid with modifications by mdh",
  "Sponsored by the IRC Autonomous Server Collective",
  "http://www.ircasc.org/",
  "", 0
};
